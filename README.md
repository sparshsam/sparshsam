...
| Area | Project | Role |
| --- | --- | --- |
| Command center | [Builder Journal](https://github.com/sparshsam/builder-journal) | Public builder journal and ecosystem command center for project direction, status, decisions, and maintenance. |
